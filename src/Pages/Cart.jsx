...
const Cart = () => {
    ...
    const calculateShippingCost = () => {
        ...
        if (selectedOptionShipping == 'servientrega a domicilio' || selectedOptionShipping == 'servientrega Oficina') {
            ...
            setIsPriceShipping(((isWeightOffset * 0.874)) + 12.50)
            ...
            <div className='cart_product_container' >
                            ...
                            freeProducts > 0 ?
                                <div className="cart_free_container">
                                    <div className="cart_alert_button_free">
                                        ...
                                        <h5 className='cart_info_unit_free'>Productos gratis: {freeProducts} Pares</h5>
                                    </div>
                ...
                >
                    ...
                    <ul className='cart_info_message_container'>
                        <li className='cart_info_message'>Llevas {quantityProductCart} pares{quantityProductCartFree > 0 && ` y ${quantityProductCartFree} de obsequio`}. 🧦</li>
                    </ul>
                    ...
                    <div className="cart_info_total_container">
                        <ul className='cart_info_total'>
                            <li className='cart_info_total_text'>Total a pagar:</li>
                            <li className='cart_info_total_numb'>$ {((quantityProductCart * priceUnit) + isPriceShipping).toFixed(2)}</li>
                    ...
                    <div className="cart_button_container">
                        ...
                        <button className='cart_button_send_order' onClick={handlePaidTransfer}>Pagar con Transferencia</button>
                    </div>
